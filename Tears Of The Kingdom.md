...
---
## 数值-大师之剑
**大师之剑**是王泪中的一种单手剑类武器，由于其特性，面对不同种类的敌人具有不同的数值特性，也具有多种攻击方式
[大师之剑本体伤害介绍](https://b23.tv/V9mdpGa)  
具体可分为三类：<br>
- 普通状态 伤害-30 耐久-40
- 半开光状态 伤害-45 耐久-40
- 全开光状态 伤害-60 耐久-无限
> 在玩家附近有瘴气生物时，大师之剑进入**半开光**状态  
> 在玩家附近有“幻影加农”“加农多夫-第一阶段”“加农多夫-第二阶段”“加农多夫-龙形态”时，大师之剑进入**全开光**状态  
> 其余情况大师之剑为**普通**状态  
> 大师之剑和其余材料进行“余料建造”时，增加对应材料攻击力，不额外增加耐久  
角色生命值全满时，按住R键蓄力并松开可以发射剑气，剑气伤害和开光状态有关  
大师之剑的近战攻击可反弹来自“加农多夫-第二阶段”的瘴气弹幕并反弹
...
|4|普攻-普通-最后一击|使用剩**1**点耐久的普通状态大师之剑打击目标|造成`30`点伤害，播放大师之剑破碎效果|
|5|普攻-半开光-最后一击|使用剩余**1**点耐久的半开光状态大师之剑打击目标|造成`30`点伤害，播放大师之剑破碎效果|
|6|剑气-普通|使用**普通**状态大师之剑发射剑气|造成`20`点伤害，耐久-1|
|7|剑气-半开光|使用**半开光**状态大师之剑发射剑气|造成`20`点伤害，耐久-1|
|8|剑气-全开光|使用**全开光**状态大师之剑发射剑气|造成`60`点伤害，不减少耐久，播放特效|
|9|剑气-无效|在非满生命值状态使用任何状态大师之剑发射剑气|无法发射剑气，不消耗耐久|
|10|瘴气弹幕打击|使用全开光状态大师之剑打击瘴气弹幕|弹幕被反弹，造成`15`点伤害|
|11|普攻-普通-余料建造|使用余料建造了攻击力为`n`的**普通**状态大师之剑打击目标|造成`30+n`点伤害，耐久-1|
|12|普攻-半开光-余料建造|使用余料建造了攻击力为`n`的**半开光**状态大师之剑打击目标|造成`45+n`点伤害，耐久-1|
|13|普攻-全开光-余料建造|使用余料建造了攻击力为`n`的**全开光**状态大师之剑打击目标|造成`60+n`点伤害，不减少耐久，播放特效|
|14|普攻-普通-余料建造-最后一击|使用余料建造了攻击力为`n`的剩**1**点耐久的普通状态大师之剑打击目标|造成`30+n`点伤害，播放大师之剑破碎效果|
|15|普攻-半开光-余料建造-最后一击|使用余料建造了攻击力为`n`的剩余**1**点耐久的半开光状态大师之剑打击目标|造成`45+n`点伤害，播放大师之剑破碎效果|