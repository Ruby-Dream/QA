...
|12|普攻-普通-余料建造|使用余料建造了攻击力为`n`的普通状态大师之剑打击目标|造成`30+n`点伤害，耐久-1|
|13|普攻-半开光-余料建造|使用余料建造了攻击力为`n`的半开光状态大师之剑打击目标|造成`45+n`点伤害，耐久-1|
|14|普攻-全开光-余料建造|使用余料建造了攻击力为`n`的全开光状态大师之剑打击目标|造成`60+n`点伤害，不减少耐久，播放特效|
|15|普攻-普通-余料建造-最后一击|使用余料建造了攻击力为`n`的剩**1**点耐久的普通状态大师之剑打击目标|造成`(30+n)*2`点伤害，播放大师之剑破碎效果|
|16|普攻-半开光-余料建造-最后一击|使用余料建造了攻击力为`n`的剩余**1**点耐久的半开光状态大师之剑打击目标|造成`(45+n)*2`点伤害，播放大师之剑破碎效果|